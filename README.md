...
Windows launcher: build `OpenDesign.exe` yourself with the instructions in `tools/launcher/README.md`. Then place it in the repo root and double-click it to run `pnpm install` if needed and start Open Design with `pnpm tools-dev`.
