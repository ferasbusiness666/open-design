...
Atalho do Windows: você também pode dar dois cliques em `OpenDesign.exe` na raiz do repo. Ele executa `pnpm install` se faltarem dependências e depois inicia o Open Design com `pnpm tools-dev`.
